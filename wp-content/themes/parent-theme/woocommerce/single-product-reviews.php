...
$allow_form   = get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() );
?>
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		<h2 class="woocommerce-Reviews-title">
			...
			if ( $count && wc_review_ratings_enabled() ) {
				$reviews_title = sprintf(
					esc_html(
						_n( // translators: 1: reviews count 2: product name
							'Reviews(%1$s)',
							'Reviews(%1$s)',
							$count,
							'woocommerce',
		...
		<div class="subtitle">
			<?php echo WLD_WC_OF_Loop::display_stars_rating_custom( 'reviews' ); ?>
