...
class WLD_WC_Video_URL_For_Gallery_Base {
	...
	public static function add_field( array $fields, WP_Post $post ) : array {
		if ( wp_attachment_is_image( $post ) ) {
			...
			$fields[ static::KEY ] = array(
				'value' => $value ?: '',
				'class' => 'widefat',
				'label' => esc_html__( 'Product Gallery Video URL', 'theme' ),
			);
		}
	...
	public static function set_video_url_in_full_gallery_size( bool|array $downsize, int|string $attachment_id, array|string $size ) : bool|array {
