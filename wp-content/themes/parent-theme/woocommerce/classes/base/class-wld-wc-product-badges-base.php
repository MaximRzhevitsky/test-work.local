...
/** @noinspection PhpUnused, UnknownInspectionInspection, PhpUndefinedFunctionInspection, PhpUndefinedMethodInspection, PhpUndefinedClassInspection */

class WLD_WC_Product_Badges_Base {
	public static function init( array $args = array() ) : void {
		...
		//new WLD_WC_Product_Badge( esc_html__( 'Other', 'theme' ) );
	}
	...
	public static function sale_badge() : string {
		...
		if ( $product->is_type( 'variable' ) ) {
			...
			$min_sale_price    = $product->get_variation_sale_price();
			$max_sale_price    = $product->get_variation_sale_price( 'max' );
			$min_regular_price = $product->get_variation_regular_price();
