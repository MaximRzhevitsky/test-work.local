...
class WLD_WC_Product_Tabs_Base {
	public static array $tabs = array();
	...
	public static function init() : void {
		...
		//new WLD_WC_Product_Tab( esc_html__( 'Other', 'theme' ), 40 );
	}
	...
	public static function tabs( array $tabs ) : array {
		...
		if ( isset( $tabs['additional_information'] ) ) {
			$tabs['additional_information']['title'] = esc_html__( 'Product Information', 'theme' );
		}
