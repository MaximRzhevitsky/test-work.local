	...
	<div class="content">
		<?php if ( $order ) : ?>
			...
			<?php if ( $order->has_status( 'failed' ) ) : ?>
				<h2 class="title"><?php esc_html_e( 'Unfortunately.', 'theme' ); ?></h2>
			...
			<?php else : ?>
				...
				<h2 class="title"><?php esc_html_e( 'Thank you!', 'theme' ); ?></h2>
				<p class="woocommerce-thankyou-order-received">
					<?php
					echo apply_filters(
						'woocommerce_thankyou_order_received_text',
						esc_html__( 'Your order was completed successfully!', 'theme' ),
						$order
					);
					?>
				</p>
