...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( '<strong>Enter a new password below.</strong>', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
